...
puts "Part 0: #{IntcodeProgram.new("1,0,0,0,99".split(',').map(&:to_i)).run}"
puts "Part 0: #{IntcodeProgram.new("1,1,1,4,99,5,6,0,99".split(',').map(&:to_i)).run}"

puts "Part 1: #{IntcodeProgram.new(part_1_input).run}"
