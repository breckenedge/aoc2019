...
part_1 = IntcodeComputer.new
part_1.load(part_1_input)
part_1.execute

puts "Part 1: #{part_1.memory[0]}"

part_2 = IntcodeProgramInputSeeker.new
puts "Part 2: #{part_2.seek(program: input, goal: 19690720, noun_range: (0..99), verb_range: (0..99)).join}"
